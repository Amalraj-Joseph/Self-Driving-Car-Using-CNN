...
#load the model
model = load_model('refraining_model/self_driving_car_model_refraining.h5')
...
while True:
    ...
    if keyboard.is_pressed('n')==False:
        ...
        current_steering=client.getCarControls().steering
        ...
        model.fit(np.array(img_resized),np.array([current_steering]))